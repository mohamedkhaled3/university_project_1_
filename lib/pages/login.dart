...
import 'package:university_project/pages/register.dart';
          ...
          child: Padding(
            ...
            child: Column( mainAxisAlignment:  MainAxisAlignment.center,
              children: [
                ...
                TextField(
                    keyboardType: TextInputType.visiblePassword, // shape of keyboard
                ...
                ElevatedButton(
                  onPressed: () {},
                  style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(BTNgreen), // BTNgreen = Color.fromARGB(255, 241, 39, 100);
